...
from LuminUserService.app.application.commands import ActivateHandler
from LuminUserService.app.application.commands import BlockHandler
from LuminUserService.app.application.commands import ChangeAvatarURLHandler
from LuminUserService.app.application.commands import ChangeBioHandler
from LuminUserService.app.application.commands import ChangeDateHandler
from LuminUserService.app.application.commands import ChangeEmailHandler
from LuminUserService.app.application.commands import ChangeLanguageCodeHandler
from LuminUserService.app.application.commands import ChangePhoneHandler
from LuminUserService.app.application.commands import ChangePrivacySettingsHandler
from LuminUserService.app.application.commands import ChangeUsernameHandler
from LuminUserService.app.application.commands.deactivate import DeactivateHandler
from LuminUserService.app.application.commands import DeleteHandler
from LuminUserService.app.application.commands import RecordProfileViewHandler
