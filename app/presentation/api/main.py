...
from LuminUserService.app.infrastructure.cache import CacheConfig
...
async def lifespan(app: Litestar):
    ...
    try:
        ...
        from LuminUserService.app.infrastructure.tasks import startup_broker
        ...
        try:
            from LuminUserService.app.infrastructure.tasks import shutdown_broker
